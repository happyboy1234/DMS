...
<div class="container">
    ...
    <ul class="layui-nav right" lay-filter="">
        ...
        <li class="layui-nav-item to-index"><a href="/loginOut.action">前台首页</a></li>
    </ul>
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content" >
            <div class="layui-tab-item layui-show o_div" >
                <span class="o_span">${sessionScope.ad.aUsername}管理员，欢迎来到宿舍管理系统！</span>
                <div class="layui-col-md6" style="padding: 30px;left: 60px;background-color: #F2F2F2;">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body">
                            ...
                            用户名：${sessionScope.ad.aUsername}
                        </div>
                        <div class="layui-card-body">
                            姓名：${sessionScope.ad.aName}
                        </div>
                        <div class="layui-card-body">
                            电话：${sessionScope.ad.aPhone}
                        </div>
                        <div class="layui-card-body">
                            级别描述：${sessionScope.ad.aDescribe}
                        </div>
                    </div>
                </div>
            </div>
