...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="xyz.codedog.po.Admin" %>
...
<div class="x-nav">
    ...
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="/findAdmin.action" title="刷新">
        ...
        <c:forEach items="${ai}" var="ai">
            <tr>
                ...
                <td class="td-manage">
                    ...
                    <a title="删除" onclick="member_del(this,'${ai.aId}','${ai.aPower}')" href="javascript:;">
                        <i class="layui-icon">&#xe640;</i>
                    </a>
                </td>
            </tr>
            ...
            <form class="layui-form" id="addEmployeeForm">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="aUsername" class="layui-input" placeholder="请输入用户名">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="password" lay-verify="required" name="aPassword"  class="layui-input" placeholder="请输入密码">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="aName" class="layui-input" placeholder="请输入姓名">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="aPhone" class="layui-input" placeholder="请输入电话">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" lay-verify="required" name="aPower"  class="layui-input" placeholder="请输入级别1-2">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="aDescribe" class="layui-input" placeholder="请输入级别描述">
                    </div>
                </div>
...
<script>
    ...
    function member_del(obj,a_id,a_power){
        var power = ${sessionScope.ad.aPower};
        var id = ${sessionScope.ad.aId};
        if(power != 1 && id != a_id){
            layer.alert("对不起，您没有权限:(");
        }
        else {
            layer.confirm('确认要删除吗？',function(index){
                //发异步删除数据
                $.get("/deleteAdmin.action",{"a_id":a_id},function (data) {
                    if(data = true){
                        layer.msg('删除成功!',{icon:1,time:2000});
                        setTimeout(function () {window.location.href='/findAdmin.action';},2000);
                    }else {
